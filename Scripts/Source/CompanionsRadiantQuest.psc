...
LeveledItem Property HarbingerRewardSmall auto
LeveledItem Property HarbingerRewardMedium auto
LeveledItem Property HarbingerRewardLarge auto
...
Function Setup()
	...
	if     (level < 10)
		RewardAmount = HarbingerRewardSmall.GetGoldValue()
	elseif (level < 20)
		RewardAmount = HarbingerRewardSmall.GetGoldValue()
	elseif (level < 20)
		RewardAmount = HarbingerRewardMedium.GetGoldValue()
	elseif (level < 20)
		RewardAmount = HarbingerRewardMedium.GetGoldValue()
	else
		RewardAmount = HarbingerRewardLarge.GetGoldValue()
	endif
